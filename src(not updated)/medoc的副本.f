...
C                                                                       ACXY0292
   ...
   35 TRUC=TRUC**ME                                                     ACXY0304
      ...
      Y=XG(NG)                                                          ACXY0306
      DO 36 JN=2,NG                                                     ACXY0307
      NN=NG-JN+1                                                        ACXY0308
   36 Y=Y*ALAMXI+XG(NN)                                                 ACXY0309
...
C                                                                       ACXY0324
     ...
     3TRIC,TRUC,XF,XFP,XG,XGP,Y,YP                                      ACXY0328
...
C                                                                       ACXY0561
     ...
     1-R*R*(SUM*SPI+SG*SAM)/8.D0                                        ACXY0563
      ...
      CRAD=CRAD+OMEZUT*GAMRAD                                           ACXY0565
      RETURN                                                            ACXY0566
      END                                                               ACXY0567
...
C                                                                       ACXY0571
     ...
     4TRIC,TRUC,XF,XFP,XG,XGP,Y,YP                                      ACXY0576
